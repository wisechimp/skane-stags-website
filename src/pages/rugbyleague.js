...
export default () => (
  <Layout pageTitle="Rugby League">
    ...
    <Video videoId="vFwHtFJarhE" altText="An introduction to rugby league." />
    <div className="bodyContent">
      <br />
      <h3>
        <i>A Brief History</i>
      ...
      <div>
        <p>
          In 1895 representatives of 22 clubs based in the North of England
          ...
          players for turning out for the club. At the time players worked 6
          ...
          Football (or Soccer for some of our overseas brothers!) had recently
          become professional and were concerned at the increasing numbers of
          working class people playing that game, a situation that they didn't
          want repeated with rugby!
        </p>
        <br />
        <p>
          Over the following years the RFL took steps to make the game more open
          and exciting for fans, in order to afford paying their players. These
          included reducing the number of players to 13, removing the line out,
          reducing the number of points for a penalty kicks to encourage more
          tries and eventually introducing the play the ball after a tackle,
          giving us the game we know and recognise today as a distinct sport
          from rugby union.
        </p>
      </div>
    </div>
