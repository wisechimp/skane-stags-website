  ...
  <Layout pageTitle="About Skane Stags">
    ...
    <div>
      ...
      <div className="bodyContent">
        ...
        <br />
        <p>
          <Link to="/training/">Training</Link> is held every Saturday in Malmö
          during a season which generally runs from February to October
          depending on the fickle Skånsk weather. We are always looking for new
          players so if you've experienced rugby in either of its forms
